...
const Hero = () => {
  return (
    <section className="max-w-[95%]  w-full md:px-[80px] mx-4 relative mt-10 md:mt-[134px]">
      <div className="w-full md:w-1/2 flex flex-col justify-between">
        <div className="flex flex-col">
          <p className="text-black font-bold text-[16px] leading-[24px] mb-4 md:mb-1">
            Join our premier monthly meetup for startup founders and tech
            visionaries
          </p>
          <h2 className="text-[#5C00B3] font-extrabold md:font-bold text-[55px] leading-[50px] md:text-[45px] md:leading-[65px] mt-2">
            Connect, Collaborate, Innovate!
          </h2>
          <p className="text-[#0a0a0a] font-normal text-20px md:text-[24px] leading-[36px] mt-[39px]">
      ...
      <img
        ...
        className="absolute top-[430px] left-[950.68px] hidden md:block"
      />
      <img
        src="/Frame 17.png"
        alt="Founders Friday graphics"
        className="absolute top-[100px] left-[1200.15px] z-[1] hidden md:block"
      />
      <img
        src="/Frame 16.png"
        alt="Founders Friday graphics"
        className="absolute -top-[20px] left-[946.3px] hidden md:block"
      />
      <img
        src="/Frame 22.png"
        alt="Founders Friday graphics"
        className="absolute top-[561.76px] left-[1300px] hidden md:block"
      />
      <img
        src="/Vector 1.png"
        alt="Background vector"
        className="absolute -top-[150px] left-[550px] -z-10 hidden md:block"
      />
    </section>
  );
};
