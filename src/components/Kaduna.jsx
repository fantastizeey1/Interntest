    ...
    <section className="bg-[url('/bg.png')] bg-cover bg-center bg-no-repeat w-full h-[500px] md:h-[808px] flex items-center justify-center mt-16">
      <div className="max-w-[95%] w-full px-4 md:px-[80px] relative mt-10 md:mt-[50px] gap-6 flex flex-col lg:flex-row justify-between items-center">
        ...
        <div className="w-full lg:w-3/5 flex flex-col items-center md:items-start text-center lg:text-left">
          <h3 className="text-[#EBE9ED] text-[22px] sm:text-[28px] md:text-[50px] leading-[28px] sm:leading-[34px] md:leading-[62.5px] font-bold mb-2 md:mb-4">
          ...
          <p className="text-[14px] sm:text-[16px] md:text-[24px] leading-[20px] sm:leading-[22px] md:leading-[29px] font-normal text-[#EBE9ED] mb-4 md:mb-[25px]">
          ...
          <button className="md:w-full w-3/4 border-2 border-[#A649FF] text-[#A649FF] px-4 sm:px-[50px] py-3 md:py-[20px] rounded-[30px] md:rounded-[40px] flex items-center justify-center justify-self-center gap-5 text-[16px] sm:text-[18px] md:text-[24px] font-bold">
            Register
        ...
        <div className="w-full hidden  lg:w-1/2 lg:flex justify-end mt-6 lg:mt-0">
          <img
            ...
            className="  lg:max-w-[595px] h-[554px]"
          />
        </div>
      </div>
    </section>
