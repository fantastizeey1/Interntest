  ...
  return (
    <section className="max-w-[95%]  w-full md:px-[80px] mx-4 relative mt-10 lg:mt-[180px] gap-10 flex flex-col">
      ...
      <div className="flex justify-between flex-col gap-[25px]">
        <div className=" w-full flex justify-evenly flex-col items-start md:flex-row md:items-center border-b border-[#3C3641] py-[15px] lg:py-[55px] min-h-[160px]">
          <img
            src="/Ellipse 308.png"
            alt=""
            className="w-[25px] h-[25px] -ml-[50px] mr-[40px] hidden md:block"
          />
          <h3 className="font-semibold text-[40px] leading-[50px] text-black text-start mb-3">
            Monthly Meetups
          </h3>
          <p className="font-semibold text-[16px] leading-[25px] text-[#75687E] text-start md:ml-[100px] lg:w-3/6">
        ...
        <div className=" w-full flex justify-evenly flex-col items-start md:flex-row md:items-center border-b border-[#3C3641] py-[15px] lg:py-[15px] min-h-[160px]">
          <div className="flex justify-between items-center w-2/6">
            ...
            />
            <h3
              className="font-semibold text-[40px] w-3/4 leading-[50px] text-black text-start
             -pl-40 mb-3"
            >
        ...
        <div className=" w-full flex justify-evenly flex-col items-start md:flex-row md:items-center border-b border-[#3C3641] py-[15px] lg:py-[55px] lg:min-h-[160px]">
          <img
            src="/Ellipse 308.png"
            alt=""
            className="w-[25px] h-[25px] -ml-[50px] mr-[40px] hidden md:block"
