...
const Attendees = () => {
  return (
    <section className="max-w-[95%] w-full px-4 md:px-[50px] 2xl:px-[80px] mx-auto mt-10 lg:mt-[180px] gap-10 flex flex-col justify-between items-center relative">
      <div className="flex flex-col justify-center items-center mb-[100px]">
        ...
        <img
          src="/Frame 640.png"
          alt="button"
          className="absolute top-[10%] md:top-[6%] lg:right-0 cursor-pointer mt-4"
        />
      </div>

      {/* Reviews Section */}
      <div className="flex flex-col md:flex-row justify-center items-center mt-6 gap-12 md:gap-[50px] 2xl:gap-[100px]">
